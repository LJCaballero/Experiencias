...
const UserReservationsPage = () => {
  ...
  const canRateExperience = (reservation) => {
    return (
      reservation.reservation_status === "completed" && !reservation.rating
    );
  };
                  ...
                  <div className="reservation-content">
                    ...
                    <p className="experience-description">
                      {reservation.experience_description.length > 120
                        ? `${reservation.experience_description.substring(
                            0,
                            120
                          )}...`
                    ...
                    {isExperienceInPast(reservation) &&
